...
int main(int argc, char** argv) {
	...
	// 2- Move to Tip
	ROS_INFO("Action server started, sending goal: Move to Tip");
	...
	// 3- Move Upward
	ROS_INFO("Action server started, sending goal: Move Upward");
	...
	// 4- Move Downward
	ROS_INFO("Action server started, sending goal: Move Downward");
